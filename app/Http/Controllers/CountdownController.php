...
class CountdownController extends Controller
{
    ...
    // const STRING_FOR_HUMAN = '{hours} tahun, {weeks} minggu, {days} hari,'
    ...
    public function waktumaks()
    {
        ...
        $datas = Penyewaan::with('penyewa')->get();
        //dd($datas);
        //->where('waktu_maks', '>', Carbon::now(new \DateTimeZone('Asia/Jakarta')))->first()->waktu_maks->toDateTimeString()->get();
        //first()->toDateTimeString()->
        //waktu_maks->
        $datass = $datas->toArray();
        $datasss = array_collapse($datass);
        //dd($datasss);
        $waktumaksi = $datasss['waktu_maks'];
    //     Carbon::createFromFormat('Y-m-d H:i:s', $some_date, 'UTC')
    // ->setTimezone('America/Los_Angeles')
        $waktumaksim = strtotime($waktumaksi);
        ...
        //return $time;
        return view('sewa.notifikasisewa', ['time' => $time]);
    }
