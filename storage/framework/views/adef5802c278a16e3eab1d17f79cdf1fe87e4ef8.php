      ...
      <nav class="navbar navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
          <div class="container d-flex align-items-stretch">
              <div class="col-3 d-flex align-items-right">
                <a class="navbar-brand" href="<?php echo e(url ('/home1')); ?> ">Bogor<span>Kayuh</span></a>
              </div>
    ...
    <!-- <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('maunyewa')); ?>" aria-label="<?php echo e(__('Sewa')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="waktu_mulai" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Waktu Penyewaan')); ?></label>

                            <div class="col-md-6">
                                <input id="waktu_mulai" type="timestamp" class="form-control<?php echo e($errors->has('waktu_mulai') ? ' is-invalid' : ''); ?>" name="waktu_mulai" value="<?php echo e(old('waktu_mulai')); ?>" required autofocus>

                                <?php if($errors->has('waktu_mulai')): ?>
                                    <span class="invalid-feedback" role="alert">
                                        <strong><?php echo e($errors->first('waktu_mulai')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="durasi" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Lama Penyewaan')); ?></label>

                            <div class="col-md-6">
                                <input id="durasi" type="integer" class="form-control<?php echo e($errors->has('durasi') ? ' is-invalid' : ''); ?>" name="durasi" value="<?php echo e(old('durasi')); ?>" required autofocus>

                                <?php if($errors->has('durasi')): ?>
                                    <span class="invalid-feedback" role="alert">
                                        <strong><?php echo e($errors->first('durasi')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="jenis" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Jenis Sepeda')); ?></label>
                        ...
                        <div class="form-group row">
                            <label for="jumlah" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Jumlah Sepeda')); ?></label>

                            <div class="col-md-6">
                                <input id="jumlah" type="integer" class="form-control<?php echo e($errors->has('jumlah') ? ' is-invalid' : ''); ?>" name="jumlah" value="<?php echo e(old('jumlah')); ?>" required autofocus>
                ...
                <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                            <a href="<?php echo e(route('home1')); ?>" class="btn btn-primary">Kembali</a>
                            </div>
                </div>
                  ...
                  <form method="POST" action="<?php echo e(route('maunyewa')); ?>" aria-label="<?php echo e(__('Sewa')); ?>">
                    ...
                    <div class="form-group">
                            ...
                            <div class="form-input">
                                <input id="jumlah" placeholder="Jumlah Sepeda" type="integer" class="form-input<?php echo e($errors->has('jumlah') ? ' is-invalid' : ''); ?>" name="jumlah" value="<?php echo e(old('jumlah')); ?>" required autofocus>
                ...
                <div class="row d-flex align-items-center">
                  <div class="col-md-6 ftco-animate">
                    ...
                    <div class="form-group">
                            ...
                            <div class="form-input">
                                <input id="durasi" placeholder="Durasi Penyewaan" type="integer" class="form-input<?php echo e($errors->has('durasi') ? ' is-invalid' : ''); ?>" name="durasi" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-input">
                                <input id="waktu_mulai" placeholder="Waktu Mulai" type="timestamp" class="form-input<?php echo e($errors->has('waktu_mulai') ? ' is-invalid' : ''); ?>" name="waktu_mulai" value="<?php echo e(old('waktu_mulai')); ?>" required autofocus>
        ...
        <div class="row mt-5">
          <div class="col text-center">
            <div class="block-27">
              ...
              <!-- <p><a href="<?php echo e(route('loginPenyewa')); ?>" class="submit-link submit">Penyewa</a> <a href="<?php echo e(route('loginAdmin')); ?>" class="submit-link submit">Admin</a></p>
...
</html><?php /**PATH C:\xampp\htdocs\divinProject\multi-auth\resources\views/penyewa.blade.php ENDPATH**/ ?>