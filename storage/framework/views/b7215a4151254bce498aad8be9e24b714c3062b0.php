                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                           ...
                           <tbody>
                           <?php $__currentLoopData = $penyewaans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <tr>
                                   <td><?php echo e($p->emailn); ?></td>
                                   <td><?php echo e($p->id_penyewaan); ?></td>
                                   <td><?php echo e($p->waktu_mulai); ?></td>
                                   <td><?php echo e($p->durasi); ?></td>
                                   <td><?php echo e($p->bayar); ?></td>
                                   <td>
                                       <div class="btn-group">
                   <!-- <a href="http://localhost/divinProject/multi-auth/public/login/admin/konfirmasi/lunas/<?php echo e($p->id_penyewaan); ?>" class="btn btn-primary">Lunas</a> -->
                                           <a href="http://localhost/divinProject/multi-auth/public/konfirmasi/lunas/<?php echo e($p->id_penyewaan); ?>" class="btn btn-primary" value=$id_penyewaan>Lunas</a>
...
<script src="<?php echo e(asset('vendor/jquery-3.2.1.min.js')); ?>"></script>
    <!-- Bootstrap JS-->
    <script src="<?php echo e(asset('/bootstrap-4.1/popper.min.js')); ?>"></script>
...
<!-- end document-->
<?php /**PATH C:\xampp\htdocs\divinProject\multi-auth\resources\views/admin.blade.php ENDPATH**/ ?>