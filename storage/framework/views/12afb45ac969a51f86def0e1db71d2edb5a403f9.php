                            ...
                            <form class="form-header" action="" method="POST">
                                ...
                                <button class="au-btn--submit" type="submit">
                                    <i class="zmdi zmdi-search"></i> -->
                                                ...
                                                <a href="konfirmasi">
                                                    <i class="btn btn-default"></i>kembali</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview"
                            <div class="col-lg-9">
                                <h2 class="title-1 m-b-25">Riwayat Sewa</h2>
                           ...
                           <tbody>
                           <?php $__currentLoopData = $riwayat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <tr>
                                   <td><?php echo e($b->emailn); ?></td>
                                   <td><?php echo e($b->id_penyewaan); ?></td>
                                   <td><?php echo e($b->waktu_mulai); ?></td>
                                   <td><?php echo e($b->durasi); ?></td>
                                   <td><?php echo e($b->bayar); ?></td>
...
<!-- end document-->
<?php /**PATH C:\xampp\htdocs\divinProject\multi-auth\resources\views/riwayatadmin.blade.php ENDPATH**/ ?>