          ...
          <div class="col-md-9 ftco-animate pb-5 text-center">
            ...
            <div class="main">
                ...
                <div class="container">
                    ...
                    <div class="card-body">
                        <form method="POST" action='{{ url("login/penyewa") }}' aria-label="{{ __('Login') }}">
                            @csrf

                        <div class="form-group">
                            <!-- <label for="email" class="form-input">{{ __('Email') }}</label> -->

                            <div class="form-input">
                                <input id="email" placeholder="Email" type="email" class="form-input{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus>
