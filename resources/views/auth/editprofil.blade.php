                  ...
                  <span class="pt-1 mr-1"></span> <span class="oi oi-menu"></span>
                      ...
                      <div class="collapse navbar-collapse" id="ftco-nav">
                        <ul class="navbar-nav ml-auto">
                          ...
                          <li class="nav-item"><a href="{{ route('maunyewa') }}" class="nav-link">Halaman Penyewaan</a></li>
              ...
              <div class="row"> -->
                <!-- ini kodingan buat upload foto -->
                  ...
                  <div class="col-md-9 personal-info">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('editprofil') }}">
                        @csrf
                       
                        <div class="form-group">
                                <label for="nama" class="col-lg-3 control-label">{{ __('Nama Lengkap') }}</label>
                        ...
                        <div class="form-group">
                                <label for="nama_pengguna" class="col-lg-3 control-label">{{ __('Nama Pengguna') }}</label>

                                <div class="col-lg-8">
                                    <input id="nama_pengguna" type="text" class="form-control{{ $errors->has('nama_pengguna') ? ' is-invalid' : '' }}" name="nama_pengguna" value="{{ old('nama_pengguna') }}" required autofocus>
                        ...
                        <div class="form-group">
                                <label for="no_telepon" class="col-lg-3 control-label">{{ __('No. Telepon') }}</label>
                        ...
                        <div class="form-group">
                                <label for="alamat" class="col-lg-3 control-label">{{ __('Alamat') }}</label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <span></span>
                            <a href="{{ route('home1') }}" class="btn btn-default">Kembali</a>
