  ...
  <nav class="navbar navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
          <div class="container d-flex align-items-stretch">
              <div class="col-3 d-flex align-items-right">
                <a class="navbar-brand" href="{{ url ('/') }}" >Bogor<span>Kayuh</span></a>
              </div>
                ...
                <div class="container">
                    <div class="signup-content">
                        ...
                        <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                            ...
                            <div class="form-group">
                            <!-- <label for="nama" class="form-input">{{ __('Nama Lengkap') }}</label> -->
        
                            <div class="form-input">
                                <input id="nama" placeholder="Nama Lengkap" type="text" class="form-input{{ $errors->has('nama') ? ' is-invalid' : '' }}" name="nama" value="{{ old('nama') }}" required autofocus>
                        ...
                        <div class="form-input">
                            ...
                            <div class="form-input">
                                <input id="nama_pengguna" placeholder="Nama Pengguna" type="text" class="form-input{{ $errors->has('nama_pengguna') ? ' is-invalid' : '' }}" name="nama_pengguna" value="{{ old('nama_pengguna') }}" required autofocus>
                        ...
                        <div class="form-input">
                            ...
                            <div class="form-input">
                                <input id="email" placeholder="Email" type="email" class="form-input{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required>
                        ...
                        <div class="form-group">
                        <div class="form-input">
                            <!-- <label for="no_telepon" class="col-md-4 col-form-label text-md-right">{{ __('Nomor Telpon') }}</label> -->

                            <div class="form-input">
                                <input id="no_telepon" placeholder="No. Telepon" type="text" class="form-input{{ $errors->has('no_telepon') ? ' is-invalid' : '' }}" name="no_telepon" value="{{ old('no_telepon') }}" required>
                        ...
                        <div class="form-input">
                            ...
                            <div class="form-input">
                                <input id="alamat" placeholder="Alamat" type="text" class="form-input{{ $errors->has('alamat') ? ' is-invalid' : '' }}" name="alamat" value="{{ old('alamat') }}" required>
                        ...
                        <div class="form-input">
                            ...
                            <div class="form-input">
                                <input id="kata_sandi" placeholder="Kata Sandi" type="password" class="form-input{{ $errors->has('kata_sandi') ? ' is-invalid' : '' }}" name="kata_sandi" required>

                                @if ($errors->has('kata_sandi'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('kata_sandi') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                        <div class="form-input">
                            <!-- <label for="kata_sandi_confirmation" class="col-md-4 col-form-label text-md-right">{{ __('Konfirmasi Kata Sandi') }}</label> -->
